...
class WebpackDevConfig extends webpack_config_base_1.WebpackBaseConfig {
    constructor(entry, output) {
        ...
        this.plugins = configPluginsWeb_1.getConfigPluginsWeb(this.entry).concat(new webpack_1.default.NamedModulesPlugin(), new webpack_1.default.HotModuleReplacementPlugin());
        this.optimization = {
            splitChunks: {
                cacheGroups: {
                    vendors: false
