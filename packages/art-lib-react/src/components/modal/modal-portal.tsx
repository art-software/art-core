...
export default class ModalPortal extends CoreComponent<IModalPortalProps, any> {
  ...
  private content: any;
  public focusAfterRender: boolean;
  ...
  private setFocusAfterRender = (focus) => {
  ...
  private afterClose = () => {
    ...
    if (!this.props.bodyOpenClassName) { return; }
  ...
  private handleOverlayOnClick = (event) => {
    ...
    return this.shouldBeClosed() ? null : (
      <UnTouchable>
        <FastClick
          ...
          style={{ ...overlayStyles, ...style.overlay, ...overlayMaskStyles }}
        />
        <div
          className="modal-portal-wrap"
