 ...
 */
export const doDecimalSafeMath = (a: number, operation: string, b: number, precision?: number): number => {
 ...
 * @return {Number}
 */
export const numAdd = (num1: number, num2: number, precision?: number): number => {
 ...
 * @return {Number}
 */
export const numSub = (num1: number, num2: number = 0, precision?: number): number => {
  return doDecimalSafeMath(num1, '-', num2, precision);
};
 ...
 * 
 */
export const numMulti = (num1: number, num2: number = 0, precision?: number): number => {
  return doDecimalSafeMath(num1, '*', num2, precision);
};
 ...
 * @return {Number}
 */
export const numDiv = (num1: number, num2: number = 0, precision?: number): number => {
  return doDecimalSafeMath(num1, '/', num2, precision);
};

export const amtToArr = (number: number, formatBit?: number): any[] => {
 ...
 */
export const numberFormat = (number: number, decimals: number = 0, dec_point: string = '.', thousands_sep: string = ',', useRound: boolean = false): string => {
