...
exports.webpackTask = (command, args) => __awaiter(this, void 0, void 0, function* () {
    ...
    executeNodeScript_1.default('node', finalPath, '--NODE_ENV', nodeEnv, '--BUILD_ENV', buildEnv === Env_1.Env.Production ? Env_1.EnvShort.IntegrateTesting : Env_1.EnvShort.Production, '--ART_MODULES', `${JSON.stringify(parsedModules)}`);
});
exports.webpackDll = () => {
