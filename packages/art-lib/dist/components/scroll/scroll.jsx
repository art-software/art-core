...
// Events available on iScroll instance {`react component event name`: `iScroll
// event name`}
...
export default class Scroll extends CoreComponent {
    ...
    triggerInitializeEvent() {
        ...
        if (typeof onInitialize === 'function') {
            this.withIScroll((iScrollInstance) => onInitialize(iScrollInstance));
        }
    }
    ...
    render() {
        ...
        return (<div {...this.applyArgs('scrollbar', scrollbarMode)} ref={this.setIScrollRef} className="scrollbar-wrapper" style={this.mergeProps(false, {}, wrapperStyle, { height, width })}>
        <div {...props} {...this.applyArgs('scrollbar-view')} className={this.className('scrollbar-view')} style={scrollViewStyle}/>
      </div>);
    }
}
Scroll.defaultProps = {
