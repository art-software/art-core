 ...
 *
 */
exports.runLifecycle = (lifecycle, plugins, manager, token) => {
    try {
 ...
 */
exports.runLifecycleSync = (lifecycle, plugins, manager, token) => {
    plugins
        .filter(hasMethod(lifecycle))
        .forEach((plugin) => {
        return plugin[lifecycle](manager.contextFor(plugin, token));
 ...
 */
exports.errorSync = (err, plugins, manager, token) => {
    plugins
