 ...
 *
 */
export declare const runLifecycle: (lifecycle: string, plugins: any[], manager: BatchManager, token?: string | undefined) => Promise<any>;
/**
 ...
 */
export declare const runLifecycleSync: (lifecycle: string, plugins: any[], manager: BatchManager, token?: string | undefined) => void;
/**
 ...
 */
export declare const errorSync: (err: any, plugins: any[], manager: BatchManager, token?: string | undefined) => void;
