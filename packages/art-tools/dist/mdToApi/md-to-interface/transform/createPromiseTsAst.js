...
const interfacePromiseTsAsTpl_1 = __importDefault(require("../../template/interfacePromiseTsAsTpl"));
...
exports.createPromiseParameters = (paramsTable) => {
    ...
    paramsTable.cells.forEach((value) => {
        const singleParam = objDeepCopy_1.objDeepCopy(interfacePromiseTsAsTpl_1.default.declaration.body.body[0].parameters[0]);
