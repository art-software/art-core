...
inquirer_1.confirmModules((answer) => __awaiter(this, void 0, void 0, function* () {
    ...
    fileSizeReporter_1.measureFileSizesBeforeBuild(paths_1.default.appPublic)
        ...
        // images optimzation.
        imageMinifier_1.default(stats, paths_1.default.appPublic).then(() => {
            fileSizeReporter_1.printFileSizesAfterBuild(stats, previousFileSizes, paths_1.default.appPublic, WARN_AFTER_BUNDLE_GZIP_SIZE, WARN_AFTER_CHUNK_GZIP_SIZE);
            console.log();
        });
    });
}));
