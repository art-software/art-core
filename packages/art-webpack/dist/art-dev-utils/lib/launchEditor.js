...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "fs", "path", "child_process", "os", "chalk", "shell-quote"], factory);
    }
    ...
    function printInstructions(fileName, errorMessage) {
        console.log();
        console.log(chalk_1.default.red('Could not open ' + path.basename(fileName) + ' in the editor.'));
        if (errorMessage) {
        ...
        console.log('To set up the editor integration, add something like ' +
            ...
            chalk_1.default.green('https://goo.gl/MMTaZt'));
        console.log();
    }
