...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../utils/inquirer", "../config/appConfig", "art-dev-utils/lib/choosePort", "../config/webpackDevServer", "../utils/createCompiler", "../config", "art-dev-utils/lib/prepareProxy", "art-dev-utils/lib/prepareUrls", "webpack-dev-server", "art-dev-utils/lib/chalkColors", "art-dev-utils/lib/executeNodeScript", "path"], factory);
    }
    ...
    const lunchNodeServer = (modules, port) => {
        ...
        const mockServerPath = path.join(__dirname, '../../../art-server-mock/src/index.ts');
