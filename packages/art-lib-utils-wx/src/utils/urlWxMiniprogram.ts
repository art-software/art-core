...
export const getQueryString = (name: string): string | undefined => {
  const { options } = getCurrentPage() as any;
 ...
 */
export const appendUrlParameter = (key: string, value: string, url): string => {
  url = url || '';
 ...
 * @return {String} new Url
 */
export const setUrlParams = (url: string = '', saveParamsKey: string[] = [], appendParams: object = {}): string => {
