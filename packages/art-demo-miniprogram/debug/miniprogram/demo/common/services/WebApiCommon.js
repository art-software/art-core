...
function (_WebApiMiniProgramCom) {
  _inherits(WebApiDemo, _WebApiMiniProgramCom);

  function WebApiDemo() {
    var _this;

    _classCallCheck(this, WebApiDemo);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(WebApiDemo).call(this, domains));
    _this.requestConfig = {};
  ...
  _createClass(WebApiDemo, [{
    key: "preRequest",
    value: function preRequest(requestConfig) {
      var _this2 = this;

      var xjwt = wx.getStorageSync(Storage_1.Storage.xjwt);
