...
function errorToSerializable(error) {
    ...
    const err = (Object.prototype.toString.call(error) === '[object Error]' &&
        typeof error.stack === 'string') ? error : { name: 'Error', type: 'Error', message: error, stack: '' };
    return {
        type: err.type,
        name: err.name,
        message: err.message,
...
exports.errorToSerializable = errorToSerializable;
